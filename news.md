  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card paper-card">
            <img src="{{ site.baseurl }}/img/news/bmvc2025.png?v=2" alt="BMVC 2025" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card challenge-card">
            <img src="{{ site.baseurl }}/img/news/embodied-ai-workshop.png?v=2" alt="ARNOLD Challenge" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card paper-card">
            <img src="{{ site.baseurl }}/img/news/plos-one.png?v=2" alt="PLOS One" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/qualcomm.png?v=2" alt="Qualcomm" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card paper-card">
            <img src="{{ site.baseurl }}/img/news/ict-express.png?v=2" alt="ICT Express" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card paper-card">
            <img src="{{ site.baseurl }}/img/news/cvpr2025.png?v=2" alt="CVPR 2025" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card paper-card">
            <img src="{{ site.baseurl }}/img/news/aaai2025.png?v=2" alt="AAAI 2025" class="news-img">
            <div class="card-body">
    ...
    <div class="year-section mb-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card challenge-card">
            <img src="{{ site.baseurl }}/img/news/bmvc2024.png?v=2" alt="BMVC 2024" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/ai-students.png?v=2" alt="New Students" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/nrf.png?v=2" alt="NRF Grant" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card challenge-card">
            <img src="{{ site.baseurl }}/img/news/embodied-ai-2024.png?v=2" alt="ARNOLD Challenge 2024" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/itp-metaverse.png?v=2" alt="Metaverse Program" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/itp-security.png?v=2" alt="Security Program" class="news-img">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="news-card research-card">
            <img src="{{ site.baseurl }}/img/news/itp-software.png?v=2" alt="SW Excellence Program" class="news-img">
            <div class="card-body">
